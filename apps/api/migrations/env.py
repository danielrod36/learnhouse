...
def run_migrations_offline() -> None:
    ...
    """
    url = lh_config.database_config.sql_connection_string or config.get_main_option("sqlalchemy.url")
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    if lh_config.database_config.sql_connection_string:
        configuration["sqlalchemy.url"] = lh_config.database_config.sql_connection_string
