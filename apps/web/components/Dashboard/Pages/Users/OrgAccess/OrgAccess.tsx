...
import { getAPIUrl, getUriWithOrg, getPublicUrl } from '@services/config/config'
                        ...
                        <td className="py-3 px-4 ">
                          <div className="flex items-center space-x-2">
                            <Link
                              ...
                              target="_blank"
                              href={getPublicUrl(org.slug, `/signup?inviteCode=${invite.invite_code}`)}
                            >
                              {getPublicUrl(org.slug, `/signup?inviteCode=${invite.invite_code}`)}
                            </Link>
                            <CopyButton text={getPublicUrl(org.slug, `/signup?inviteCode=${invite.invite_code}`)} />
                          </div>
                        </td>
                        <td className="py-3 px-4">
                          {invite.usergroup_id ? (
